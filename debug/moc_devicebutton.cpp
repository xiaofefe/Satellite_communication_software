/****************************************************************************
** Meta object code from reading C++ file 'devicebutton.h'
**
...
#error "The header file 'devicebutton.h' doesn't include <QObject>."
...
const QMetaObject DeviceButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_DeviceButton.data,
      qt_meta_data_DeviceButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DeviceButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DeviceButton.stringdata0))
        return static_cast<void*>(const_cast< DeviceButton*>(this));
